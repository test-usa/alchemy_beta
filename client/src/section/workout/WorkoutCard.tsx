...
const WorkoutCard = ({ image, title, description, additionalImage }: { image: string, title: string, description: string, additionalImage: string }) => {
    ...
    return (
        <div className="w-full lg:max-w-[953.32px] h-auto rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="w-full lg:h-[512px] relative">
                <img src={image} alt="Workout Image" className="w-full h-full object-cover rounded-lg" />
            </div>
            ...
            <div className="w-full py-8 px-6">
                ...
                {isExpanded && (
                    <div className="w-full mt-8">
                        ...
                        <img src={additionalImage} alt="Additional Workout Image" className="w-full h-auto object-cover rounded-lg" />
                    </div>
                )}
