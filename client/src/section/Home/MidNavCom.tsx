...
const MidNavCom = () => {
  return (
    <div className="w-full max-w-[1920px] mx-auto text-white bg-[#6636EE] flex flex-wrap md:flex-nowrap justify-around items-center px-4 md:px-6 shadow-md border-b mt-20 md:h-[80px] py-4 md:py-0">
