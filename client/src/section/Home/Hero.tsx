...
const Hero = () => {
  return (
    <div className="relative lg:w-full h-[975px] flex items-center justify-center bg-black">
      ...
      <div className="relative z-10 max-w-7xl w-full px-6 md:px-12 flex flex-col md:flex-row items-center justify-center md:justify-between text-center md:text-left">
        {/* Text Section */}
        <div className="w-full md:w-[900px] text-white max-w-2xl font-sans relative">
          <h2 className="text-2xl md:text-6xl font-light">TOTALU YOUR</h2>
          <h1 className="text-3xl md:text-6xl leading-[1.2] font-black">
          ...
          <h2 className="text-2xl md:text-6xl font-light">DREAMS!</h2>
        </div>

        {/* Athlete Image */}
        <div className="w-full md:w-[900px] relative mt-10 md:mt-0 z-30 flex justify-center">
          <div className="absolute inset-0 flex justify-center items-center ">
            <div className="w-[300px] h-[300px] md:w-[972px] md:h-[672px] bg-gradient-to-r from-[#FFFFFF]/30 to-[#C6C6C600]/30 rounded-full blur-[84px]"></div>
          </div>
          <img
            src={athlete}
            alt="Athlete"
