        ...
        <div className="mb-10">
            ...
            <div className="grid md:grid-cols-2 gap-10 mt-5">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h4 className="text-[#6636EE] font-semibold text-lg md:mb-2">Heart Healthy</h4>
                        <p className="text-sm md:text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, praesentium?</p>
                    </div>
                </div>
                <div className="flex items-center gap-5">
                    <div className="flex items-center justify-center rounded-full text-[#6636EE]  border border-gray-300 p-3">
            ...
            <div className="grid grid-cols-2 md:flex md:justify-between items-center gap-5 mt-5">
                <div className="w-full flex flex-col items-center justify-center gap-2 shadow-lg p-3 md:p-5 rounded">
                    <img className="rounded-full h-16 md:h-20 lg:h-24 w-16 md:w-20 lg:w-24 object-cover border-4 md:border-[10px] border-gray-200 my-5" src="https://img.freepik.com/free-photo/smart-looking-teacher_53876-23045.jpg?t=st=1738928725~exp=1738932325~hmac=d7b7d59b939028b2524b0f025dd21a9d3124c5c0201950c475833b9c68be41bf&w=900" alt="" />
                    <h4 className="md:text-lg font-semibold">Frances Swan</h4>
                    <p className="text-sm md:text-base text-zinc-400">Rainbow Bay crafts</p>
                </div>
                <div className="w-full flex flex-col items-center justify-center gap-2 shadow-lg p-3 md:p-5 rounded">
                    <img className="rounded-full h-16 md:h-20 lg:h-24 w-16 md:w-20 lg:w-24 object-cover border-4 md:border-[10px] border-gray-200 my-5" src="https://img.freepik.com/free-photo/smart-looking-teacher_53876-23045.jpg?t=st=1738928725~exp=1738932325~hmac=d7b7d59b939028b2524b0f025dd21a9d3124c5c0201950c475833b9c68be41bf&w=900" alt="" />
                    <h4 className="md:text-lg font-semibold">Frances Swan</h4>
