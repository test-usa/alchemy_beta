        ...
        <form onSubmit={handle}>
          ...
          <div className="flex justify-between items-center gap-5 mb-4">
            <div className="flex items-center gap-3">
              ...
              <label className="cursor-pointer" htmlFor="Checkbox">Remember</label>
            </div>
            <div className="cursor-pointer hover:text-[#6636EE] hover:underline">Forgot Password?</div>
          </div>
          <button
            type="submit"
