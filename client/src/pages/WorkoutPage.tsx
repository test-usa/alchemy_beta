  ...
  return (
    <div className="h-full container mx-auto flex flex-col sm:flex-row px-4  mt-20">
      ...
      <div className="sm:w-64 lg:w-1/4 flex flex-col gap-6 h-full ">
        {/* Sidebar */}
        <div
          className={`fixed md:static top-0 left-0 h-[120px] md:h-auto bg-white shadow-md md:shadow-none w-64 md:w-auto transition-transform transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 z-40`}
        >
          <button
