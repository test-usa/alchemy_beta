...
const WorkoutPage = () => {
  ...
  return (
    <div className="h-full container mx-auto flex flex-col sm:flex-row px-4  mt-0">
      <div className="container mx-auto px-4 mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-5 relative">
          ...
          {/* Sidebar */}
          <div
            className={`fixed  mt-20 md:static top-0 left-0 h-full md:h-auto bg-white shadow-md md:shadow-none w-64 md:w-auto transition-transform transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
