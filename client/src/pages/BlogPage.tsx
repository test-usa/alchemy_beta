...
const BlogPage = () => {
    ...
    return (
        <div className="container mx-auto flex mt-6 justify-center">
            ...
            <div className="hidden md:block w-40 sm:w-48 md:w-64">
                <div className="w-[335px] max-auto border border-gray-200 rounded p-6">
                    <h2 className="text-xl font-bold mb-4 text-[#6636EE] border-b border-b-gray-200 pb-2">All Community</h2>
                    <BlogNavItem />
                </div>
                        ...
                        <div className="w-full h-full relative flex justify-center">
                            ...
                            <div className="w-[213px] h-[87px]">
                                <div className="w-full h-full mt-8 flex justify-center">
                                    <h1 className="text-white absolute text-center">How can we help?</h1>
                                    <h1 className="text-center absolute mt-12 mx-3 text-white">info.gmail.com</h1>
                                    <h1 className="text-center absolute pt-6 text-white">+798725783</h1>
                                </div>
                            </div>
                        </div>
                    </div>
